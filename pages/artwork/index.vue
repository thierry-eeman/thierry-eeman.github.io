      ...
      <div id="cards" class="grid grid-cols-12 m-auto p-8 gap-8">
          ...
          >
            ...
            <figure>
              <img
                ...
                src="~/assets/images/reinhardt.jpg"
                alt=""
              />
        ...
        <nuxt-link to="/artwork/atoms" class="col-span-3">
          ...
          >
            ...
            <figure>
              <img
                class="w-full block h-32 object-cover object-center rounded-b-2xl blur-sm brightness-50 hover:blur-none hover:brightness-100"
                src="~/assets/images/atoms.jpg"
                alt=""
              />
              <figcaption class="text-center text-md py-5 text-slate-500">
                <p>Artwork #008</p>
        ...
        <nuxt-link to="/artwork/particles" class="col-span-3">
          ...
          >
            ...
            <figure>
              <img
                class="w-full block h-32 object-cover object-center rounded-b-2xl blur-sm brightness-50 hover:blur-none hover:brightness-100"
                src="~/assets/images/particles.jpg"
                alt=""
              />
              <figcaption class="text-center text-md py-5 text-slate-500">
                <p>Artwork #009</p>
